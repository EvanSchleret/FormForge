...
class HttpRoutesCommand extends Command
{
    ...
    public function handle(HttpOptionsResolver $resolver): int
    {
        ...
        $rows = [
            ...
            ['GET', '/' . $prefix . '/categories', 'management(categories)', $management['auth'], $management['guard'] ?? '-', implode(', ', $management['middleware'] ?? [])],
            ['GET', '/' . $prefix . '/categories/{categoryKey}', 'management(category)', $management['auth'], $management['guard'] ?? '-', implode(', ', $management['middleware'] ?? [])],
            ['POST', '/' . $prefix . '/categories', 'management(category_create)', $management['auth'], $management['guard'] ?? '-', implode(', ', $management['middleware'] ?? [])],
            ['PATCH', '/' . $prefix . '/categories/{categoryKey}', 'management(category_update)', $management['auth'], $management['guard'] ?? '-', implode(', ', $management['middleware'] ?? [])],
            ['DELETE', '/' . $prefix . '/categories/{categoryKey}', 'management(category_delete)', $management['auth'], $management['guard'] ?? '-', implode(', ', $management['middleware'] ?? [])],
